...
const messages = {
  en: {
    ...
    "profile.calendar.chooseDatesBody": "Choose the day you intend to begin each of your next three games. Availability and release dates may move the projection later.",
  ...
  "pt-BR": {
    ...
    "profile.calendar.chooseDatesBody": "Escolha o dia em que pretende começar cada um dos seus três próximos jogos. A disponibilidade e a data de lançamento podem mover a projeção para depois.",
