...
const messages = {
  en: {
    ...
    "admin.plans.body": "Manage Free and Pro accounts. Pro is the paid plan, with billing and exclusive features coming later. Plan changes here are manual and do not charge anyone.",
    "admin.plans.searchLabel": "Find an account by name, email, or ID",
    "admin.plans.changePlan": "Change plan",
  ...
  "pt-BR": {
    ...
    "admin.plans.body": "Gerencie as contas Grátis e Pro. Pro é o plano pago, com cobrança e recursos exclusivos previstos para depois. As alterações aqui são manuais e não geram cobrança.",
    "admin.plans.searchLabel": "Busque uma conta por nome, e-mail ou ID",
    "admin.plans.changePlan": "Alterar plano",
